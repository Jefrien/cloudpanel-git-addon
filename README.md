...
```bash
wget -qO- https://github.com/Jefrien/cloudpanel-git-addon/archive/refs/tags/v1.0.6.tar.gz | tar xz -C /opt/ && mv /opt/cloudpanel-git-addon-1.0.6 /opt/clp-git-addon
```
