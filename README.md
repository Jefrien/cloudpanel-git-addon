...
```bash
wget -qO- https://github.com/Jefrien/cloudpanel-git-addon/archive/refs/tags/v1.0.25.tar.gz | tar xz -C /opt/ && mv /opt/cloudpanel-git-addon-1.0.25 /opt/clp-git-addon
```
